This is a practice question derived from <a href="https://www.youtube.com/watch?v=ODrEjR-DsR0&list=PLTWRAc3irpxFC85HVVfJVEaWp2_P1II9s"> Cyberkraft </a> about the different types of security controls. 

<img src="security_controls_pbq_answers.jpg" alt="security controls pbq" width="800px">

### 1st Scenario
An IT Admin proposes installing a system to detect malicious activity after a previous attack caused significant damage. The control category for this measure would be "Technical" because it involves deploying technology to address the issue.
